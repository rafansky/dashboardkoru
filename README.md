...
El editor tactico esta disponible en `/tactics` y desde el enlace `Pizarra` del dashboard. Incluye las fases 1 a 10: editor 2D, escenas y reproduccion, anotaciones, trayectorias de varios puntos, expedientes de partido, trabajo en directo, plantillas de alineacion, convocatorias, biblioteca tactica, formaciones rapidas y modo presentacion.
